...
<div class="collapse wcfm-collapse" id="wcfm_build_listing">
	...
	<div class="wcfm-collapse-content">
		...
		<div class="wcfm-container wcfm-top-element-container">
			...
			<button class = "listing-creation"><a class="listing-text" href="<?php echo get_home_url() ?>/professional-manager/products-manage/" target="_blank">Add new listing</a></button>
