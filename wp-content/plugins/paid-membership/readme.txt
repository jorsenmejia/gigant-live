=== Paid Membership, Content, Downloads ===
...
Tags: paid membership, mycred, tokens, subscription, videowhisper, paypal, zombaio, bitcoin, sell post, pay per view
Requires at least: 2.7
Tested up to: 5.3
Stable tag: trunk

Setup paid membership (roles), custom content, downloads. Use tokens from MyCred and TeraWallet for WooCommerce.
