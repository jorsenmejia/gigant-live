...
class WCFM_Elementor_Templates {
	...
	public function __construct() {
		...
		add_action( 'woocommerce_api_wcfmem-template-preview', [ self::class, 'template_preview' ] );
	}
	...
	public static function add_template_library( $value ) {
		...
		$store_templates = [
				[
						...
						'thumbnail'         => $WCFMem->plugin_url . 'assets/images/store-header.png',
						...
						'url'               => home_url( '/?wc-api=wcfmem-template-preview' ),
				]
		];
	...
	public static function template_preview() {
		global $WCFM, $WCFMem;
		include $WCFMem->plugin_path . 'views/template-preview.php';
	}
}