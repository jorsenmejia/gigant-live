...
?>
<div id="<?php echo $id ?>-container" <?php echo $deps_html;?> class="yit_options rm_option rm_input rm_text <?php echo $class ?>">
	<div class="option">
		<div class="inner-option">
			<label for="type_action"><?php _e( 'Action', 'yith-woocommerce-points-and-rewards' ) ?></label>
			<div class="select_wrapper">
				<select id="type_action" name="type_action">
					<option value="import" selected><?php _e( 'Import', 'yith-woocommerce-points-and-rewards' ) ?></option>
					<option value="export"><?php _e( 'Export', 'yith-woocommerce-points-and-rewards' ) ?></option>
				</select>
			</div>
		</div>
		<div class="inner-option">
		...
		<div class="inner-option">
			...
			<button class="button button-primary" id="ywpar_import_points"><?php _e( 'Start', 'yith-woocommerce-points-and-rewards' ) ?></button>
		</div>
	</div>
	<div class="clear"></div>
</div>