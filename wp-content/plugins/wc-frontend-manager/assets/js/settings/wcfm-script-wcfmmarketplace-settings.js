  ...
  function initialize() {
  	...
  	if( wcfm_maps.lib == 'google' ) {
			...
			if( $store_lat && $store_lng ) {
				var map = new L.Map( 'wcfm-marketplace-map', {zoom: 13, center: new L.latLng([$store_lat, $store_lng]) });
				...
				var map = new L.Map( 'wcfm-marketplace-map', {zoom: 13, center: new L.latLng([41.575730,13.002411]) });
				map.addLayer(new L.TileLayer('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png'));	//base layer
			}
