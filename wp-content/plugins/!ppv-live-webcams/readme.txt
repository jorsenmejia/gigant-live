...
Plugin URI: https://videowhisper.com/?p=WordPress-PPV-Live-Webcams
Donate link: https://videowhisper.com/?p=Invest
Tags: ppv, videochat, webcam, cam, chat, video, live, plugin, shortcode, posts, admin, VideoWhisper, video chat, pay per minute, myCRED
Requires at least: 2.7
Tested up to: 5.3
Stable tag: trunk

Setup a PPV live webcam videochat site, for performers and clients. Pay per minute, tips, videos, pictures, HTML5, WebRTC, HLS, MPEG DASH.
...
* [WooCommerce Wallet](https://wordpress.org/plugins/woo-wallet/) gateways: Paypal, Stripe with Apple/Google Pay, Square, Amazon Pay
* [myCRED Wallet](https://wordpress.org/plugins/mycred/) gateways: Paypal, Zombaio, Skrill, NETbilling, BitPay (bitcoin)
...
* Archive streams and imort with [Video Share VOD](https://wordpress.org/plugins/video-share-vod/  "Video Share / Video On Demand") plugin
...
* Sell Pictures/Videos (with [Paid Membership and Content](https://wordpress.org/plugins/paid-membership/ "WordPress Paid Membership and Content Plugin"))
...
This plugin has [requirements](https://videowhisper.com/?p=Requirements "Live Streaming Requirements") beyond regular WordPress hosting specifications: a [RTMP host](https://hostrtmp.com/ "RTMP Hosting") is needed for persistent connections to manage live interactions and video streaming. Advanced features like transcoding and HLS/MPEG-Dash live video delivery, country access restrictions involve specific hosting requirements. More details about this, including solutions are provided on the Installation section pages.
...
[WordPress PPV Live Webcams Plugin HomePage](https://videowhisper.com/?p=WordPress-PPV-Live-Webcams "PPV Live Webcams Plugin HomePage")
[Turnkey PPV Cams Site Tutorial](https://turnkeyclone.com/ppv-videochat-cams-script/ "Turnkey PPV Cams Site Tutorial") 

= Contact, Support & Custom Development =
VideoWhisper.com can provide support and custom development for this plugin:
[Contact VideoWhisper Support](https://videowhisper.com/tickets_submit.php "Contact VideoWhisper Support") 
...
https://paidvideochat.com/features/quick-setup-tutorial/
* See latest version instructions on plugin homepage:
https://videowhisper.com/?p=WordPress-PPV-Live-Webcams
...
6. Webcam (provider) AJAX live listings.
5. Tip performer.
...
== Documentation ==
* Plugin Homepage : https://videowhisper.com/?p=WordPress-PPV-Live-Webcams
* Application Homepage : https://videowhisper.com/?p=Video-Messenger
* Turnkey PPV Cams Site Tutorial: https://turnkeyclone.com/ppv-videochat-cams-script/
* Requirements: https://videowhisper.com/?p=Requirements
* Recommended Webcam Script Hosting: https://videowhisper.com/?p=Wowza+Media+Server+Hosting 

== Demo ==
* See WordPress integration on:
https://videochat-scripts.com/webcams/
