...
Description: <strong>MicroPayments - Paid Membership, Content, Downloads</strong>: Sell membership, content, downloads based on virtual wallet credits/tokens. Credits/tokens can be purchased with real money using MyCred and TeraWallet for WooCommerce. Control access to content (including custom posts) by membership. Enable uploading files for membership/paid downloads from dedicated frontend pages. Micropayments allows users to do low value transactions from site wallet, without using a billing site each time. <a href='https://videowhisper.com/tickets_submit.php?about=paid-membership'>Contact Us</a>
Version: 1.6.7
...
EOHTML;
		...
		static function poweredBy()
		{
			...
			return '<div id="VideoWhisper" style="display: ' . $state . ';"><p>Published with VideoWhisper <a href="https://videowhisper.com/">MicroPayments - Paid Membership, Content, Downloads</a>.</p></div>';
		}
...
<br>VideoWhisper MicroPayments - Paid Membership/Content/Downloads supports custom pricing for some plugins (special discounts).
<?php
				$posts = get_posts(
					array(
