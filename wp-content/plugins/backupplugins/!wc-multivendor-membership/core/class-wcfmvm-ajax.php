...
class WCFMvm_Ajax {
  ...
  function wcfmvm_sms_verification_code() {
  	...
  	$has_error = false;
  	if( !WCFMmp_Dependencies::wcfm_sms_alert_plugin_active_check() && !WCFMmp_Dependencies::wcfm_twilio_plugin_active_check() && !WCFMmp_Dependencies::wcfm_msg91_plugin_active_check() && !function_exists( 'netgsm_sendSMS_oneToMany' ) ) {
  		$has_error = true;
  	}
