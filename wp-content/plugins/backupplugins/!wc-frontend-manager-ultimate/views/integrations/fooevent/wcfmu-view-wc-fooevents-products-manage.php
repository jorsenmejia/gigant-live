...
<div class="wcfm-container <?php echo apply_filters( 'wcfm_pm_block_class_fooevents', 'simple variable' ); ?>">
	<div id="wcfm_products_manage_form_wc_fooevents_expander" class="wcfm-content">
	  ...
	  <div id="woocommerce_events_data" class="panel woocommerce_options_panel">
        ...
        <div class="options_group">
					<p class="form-field">
						<span class="wcfm_title"><strong><?php _e('Ticket Theme:', 'woocommerce-events'); ?></strong></span>
        ...
        <div class="options_group">
					...
					<p class="form-field">
					  <?php
					  $WCFM->wcfm_fields->wcfm_generate_form_field( array( "WooCommerceEventsTicketLogo" => array( 'label' => __( 'Ticket logo:', 'woocommerce-events' ), 'type' => 'upload', 'label_class' => 'wcfm_title', 'value' => $WooCommerceEventsTicketLogo, 'hints' => __('The logo which will be displayed on the ticket in JPG or PNG format', 'woocommerce-events') ) ) );
					  ?>
					</p>
        </div>
        <div class="options_group">
					...
					<p class="form-field">
					  <?php
					  $WCFM->wcfm_fields->wcfm_generate_form_field( array( "WooCommerceEventsTicketHeaderImage" => array( 'label' => __( 'Ticket header image:', 'woocommerce-events' ), 'type' => 'upload', 'label_class' => 'wcfm_title', 'value' => $WooCommerceEventsTicketHeaderImage, 'hints' => __('The main image which will be displayed on the ticket in JPG or PNG format', 'woocommerce-events') ) ) );
					  ?>
					</p>
        </div>
        <div class="options_group">
        ...
        <?php if(!empty($product_id)) :?>
          ...
          <div class="options_group">
            ...
            <p class="form-field">
							...
							<?php
							$WCFM->wcfm_fields->wcfm_generate_form_field( array( "WooCommerceEventsPrintTicketLogo" => array( 'label' => '', 'type' => 'upload', 'label_class' => 'wcfm_title', 'value' => $WooCommerceEventsPrintTicketLogo ) ) );
							?>
