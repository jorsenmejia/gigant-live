...
class WCFMu_Dependencies {
	...
	static function wcfm_wcfm_wc_cost_of_goods_plugin_active_check() {
		if ( ! self::$active_plugins ) self::init();
	...
	// WooCommerce Smart Coupons - 6.3.0
	static function wcfm_wcfm_wc_smart_coupons_plugin_active_check() {
		if ( ! self::$active_plugins ) self::init();
