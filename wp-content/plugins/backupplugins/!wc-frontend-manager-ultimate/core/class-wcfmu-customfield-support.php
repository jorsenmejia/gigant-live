					...
					if( $product_id ) {
						if( $wcfm_product_custom_block_field['type'] == 'checkbox' ) {
							...
							if( isset( $group_value[$wcfm_product_custom_block_field['name']] ) ) {
								$field_value = '<a class="wcfm_linked_images" href="'.$group_value[$wcfm_product_custom_block_field['name']].'" target="_blank">' . wcfm_removeslashes( __( $wcfm_product_custom_block_field['label'], 'wc-frontend-manager') ) . '</a>';
							}
						} else {
							if( isset( $group_value[$wcfm_product_custom_block_field['name']] )) {
					...
					if( $product_id ) {
						if( $wcfm_product_custom_block_field['type'] == 'checkbox' ) {
							...
							if( get_post_meta( $product_id, $field_name, true ) ) {
								$field_value = '<a class="wcfm_linked_images" href="'.get_post_meta( $product_id, $field_name, true ).'" target="_blank">' . wcfm_removeslashes( __( $wcfm_product_custom_block_field['label'], 'wc-frontend-manager') ) . '</a>';
							}
						} else {
