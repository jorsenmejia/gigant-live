...
Description: Allows specify default image ( "NO IMAGE" ) for Woocommerce-products
Version: 1.0.7
Author: Игорь Тронь
Author URI: http://nebster.net
*/
	
	define( 'WCDI', 'woocommerce-default-image' );
	global $wcdi;
	$wcdi = array();
										...
										if ( attachment.id ) {
											...
											$preview.append('\
												<li class="image" data-attachment_id="' + attachment.id + '">\
													...
													<span><a href="#" class="delete_slide" title="<?php _e( 'Delete image' ); ?>"><?php _e( 'Delete' ); ?></a></span>\
												</li>');
										}
