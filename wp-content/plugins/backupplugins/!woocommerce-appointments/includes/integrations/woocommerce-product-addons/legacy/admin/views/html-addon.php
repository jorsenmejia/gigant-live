...
<div class="woocommerce_product_addon wc-metabox closed">
	<h3>
		...
		<select name="product_addon_type[<?php echo $loop; ?>]" class="product_addon_type">
			<option <?php selected('custom_price', $addon['type']); ?> value="custom_price"><?php _e('Additional custom price input', 'woocommerce-appointments'); ?></option>
			<option <?php selected('input_multiplier', $addon['type']); ?> value="input_multiplier"><?php _e('Additional price multiplier', 'woocommerce-appointments'); ?></option>
			...
			<tr>
				<td class="addon_name" width="50%">
					<label for="addon_name_<?php echo $loop; ?>">
						<?php
							_e( 'Name', 'woocommerce-appointments' );
						?>
					</label>
			...
			<tr>
				<td class="addon_description" colspan="2">
					<label for="addon_description_<?php echo $loop; ?>">
						<?php
							_e( 'Description', 'woocommerce-appointments' );
						?>
					</label>
			...
			<tr>
				<td class="data" colspan="3">
					<table cellspacing="0" cellpadding="0">
						<thead>
							<tr>
								<th><?php _e('Label', 'woocommerce-appointments'); ?></th>
								<th class="price_column"><?php _e('Price', 'woocommerce-appointments'); ?></th>
								<th class="minmax_column"><span class="column-title"><?php _e('Min / Max', 'woocommerce-appointments'); ?></span></th>
