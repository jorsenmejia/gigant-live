...
class WC_Appointments_Admin_List_Table extends WC_Admin_List_Table {
	...
	protected function render_appointment_dates_filter() {
		...
		<div class="alignleft">
			<div class="date_filter alignleft">
				<input type="search" name="date_from" class="date_from date-picker" value="<?php esc_attr_e( $date_from_formatted ); ?>" placeholder="<?php _e( 'Start Date', 'woocommerce-appointments' ); ?>" autocomplete="off" />
			</div>
			<div class="date_filter alignleft">
				<input type="search" name="date_to" class="date_to date-picker" value="<?php esc_attr_e( $date_to_formatted ); ?>" placeholder="<?php _e( 'End Date', 'woocommerce-appointments' ); ?>" autocomplete="off" />
			</div>
		</div>
		<?php
	}
	...
	protected function render_appointment_product_filter() {
		...
		?>
		<div class="alignleft">
			<select class="wc-product-search" name="filter_product" style="width: 200px;" data-allow_clear="true" data-placeholder="<?php esc_attr_e( 'Filter by product', 'woocommerce-appointments' ); ?>" data-action="woocommerce_json_search_appointable_products">
