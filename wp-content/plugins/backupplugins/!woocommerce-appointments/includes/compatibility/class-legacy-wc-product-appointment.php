 ...
 */
class Legacy_WC_Product_Appointment extends WC_Product {
	/**
	 * Needed for 2.6.x.
	 *
	 * @var string
	 */
	public $product_type = 'appointment';
	 ...
	 * @var string
	 */
	protected $data_store_name = 'product-appointment';
	...
	/**
	 * get_name did not exist before 3.0.0
	 * @return string
	 */
	...
	/**
	 * get_status did not exist before 3.0.0
	 * @return string
	 */
	public function get_status() {
		return isset( $this->post ) ? $this->post->post_status : false;
	}

	/**
	 * get_description did not exist before 3.0.0
	 * @return string
	 */
	public function get_description() {
		return isset( $this->post ) ? $this->post->post_content : false;
	}

	/**
	 * get_short_description did not exist before 3.0.0
	 * @return string
	 */
	public function get_short_description() {
		return isset( $this->post ) ? $this->post->post_excerpt : false;
	}

	/**
	 * get_parent_id did not exist before 3.0.0
	 * @return string
	 */
	public function get_parent_id() {
		return isset( $this->post ) ? $this->post->post_parent : false;
	}
	/**
	 * get_reviews_allowed did not exist before 3.0.0
	 * @return bool
	 */
	public function get_reviews_allowed() {
		return isset( $this->post ) && 'open' === $this->post->comment_status ? true : false;
	}

	/**
	 * get_menu_order did not exist before 3.0.0
	 * @return bool
	 */
	public function get_menu_order() {
		return isset( $this->post ) ? $this->post->menu_order : false;
	}
	...
	public function get_date_created() {
		return isset( $this->post ) ? $this->post->post_date : false;
	}
