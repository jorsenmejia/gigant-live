...
<fieldset class="wc-appointments-date-picker <?php echo esc_attr( implode( ' ', $class ) ); ?>">
	...
	<div class="wc-appointments-date-picker-date-fields">
        ...
        ?>
		<label>
			<input type="text" name="<?php echo esc_html( $name ); ?>_month" placeholder="<?php esc_html_e( 'mm', 'woocommerce-appointments' ); ?>" size="2" class="required_for_calculation appointment_date_month" />
			<span><?php esc_html_e( 'Month', 'woocommerce-appointments' ); ?></span>
		</label> / <label>
			<input type="text" name="<?php echo esc_html( $name ); ?>_day" placeholder="<?php esc_html_e( 'dd', 'woocommerce-appointments' ); ?>" size="2" class="required_for_calculation appointment_date_day" />
		...
		<?php endif; ?>
		/ <label>
			<input type="text" value="<?php echo esc_html( date( 'Y' ) ); ?>" name="<?php echo esc_html( $name ); ?>_year" placeholder="<?php esc_html_e( 'YYYY', 'woocommerce-appointments' ); ?>" size="4" class="required_for_calculation appointment_date_year" />
