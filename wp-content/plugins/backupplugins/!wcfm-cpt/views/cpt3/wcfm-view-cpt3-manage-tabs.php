 ...
 * WCFM plugin view
 *
 * WCFM CPT3 Manage Tabs view
 *
 * @author 		WC Lovers
 * @package 	wcfmcpt/views/cpt3
 * @version   1.0.0
 */
...
if( $cpt3_id ) {
	// Custom Meta Fields
	$custom_1 = get_post_meta( $cpt3_id, 'custom_1', true);
	$custom_2 = get_post_meta( $cpt3_id, 'custom_2', true);
	$custom_3 = get_post_meta( $cpt3_id, 'custom_3', true);
	$custom_4 = get_post_meta( $cpt3_id, 'custom_4', true);
}

?>
<!-- collapsible 1 -->
<div class="page_collapsible cpt3_manager_custom" id="wcfm_cpt3_manager_form_custom_head"><label class="fa fa-database"></label><?php _e('Custom', 'wcfm-cpt'); ?><span></span></div>
<div class="wcfm-container">
	<div id="wcfm_cpt3_manager_form_custom_expander" class="wcfm-content">
		<?php
		$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_cpt3_fields_custom', array(
