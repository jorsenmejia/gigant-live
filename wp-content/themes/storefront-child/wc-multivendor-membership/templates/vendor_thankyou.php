...
if( !$subscription_thankyou_content ) {
	$subscription_thankyou_content = "<strong>Welcome,</strong>
																		<br /><br />
																		You have successfully submitted your Professionalsasdasdsa Account request. 
																		<br /><br />
																		Your Professionals application is still under review.
																		<br /><br />
...
<div id="wcfm_membership_container">
  <div class="wcfm_membership_thankyou_content_wrapper">
		<?php if( ( $required_approval == 'no' ) && wcfm_is_vendor( $member_id ) ) { ?>
			...
			<a class="wcfm_submit_button" href="<?php echo apply_filters( 'wcfm_thank_you_left_button_url', get_wcfm_url() ); ?>"><?php echo apply_filters( 'wcfm_thank_you_left_button_label', __( 'Go to Dashboard', 'wc-multivendor-membership' ) ); ?> >></a>
