	  ...
	  <?php do_action( 'wcfmmp_store_before_policies', $store_user->get_id() ); ?>
		...
		<?php if( !wcfm_empty($shipping_policy) ) { ?>
			<div class="policies_area wcfm-shipping-policies">
				<h2 class="wcfm_policies_heading"><?php echo apply_filters('wcfm_shipping_policies_heading', __('Flexible', 'wc-frontend-manager')); ?></h2>
		...
		<?php } if( !wcfm_empty( $refund_policy ) ){ ?>
			<div class="policies_area wcfm-refund-policies">
				<h2 class="wcfm_policies_heading"><?php echo apply_filters('wcfm_refund_policies_heading', __('Moderate', 'wc-frontend-manager')); ?></h2>
		...
		<?php } if( !wcfm_empty( $cancellation_policy ) ){ ?>
			<div class="policies_area wcfm-cancellation-policies">
				<h2 class="wcfm_policies_heading"><?php echo apply_filters('wcfm_cancellation_policies_heading', __('Strict', 'wc-frontend-manager')); ?></h2>
