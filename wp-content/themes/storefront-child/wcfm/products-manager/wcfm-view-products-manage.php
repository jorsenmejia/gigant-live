<?php
        ...
        if( apply_filters( 'wcfm_is_pref_restriction_check', true ) ) {
            ...
            if( !current_user_can( 'edit_products' ) || !$wcfm_is_allow_manage_products ) {
                wcfm_restriction_message_shscow( "Products" );
                return;
            }
        }
        ...
        $product_types = apply_filters( 'wcfm_product_types', array('appointable' => __('Simple Product', 'wc-frontend-manager'), 'variable' => __('Variable Product', 'wc-frontend-manager'), 'grouped' => __('Grouped Product', 'wc-frontend-manager'), 'external' => __('External/Affiliate Product', 'wc-frontend-manager') ) );
          ...
          <div class="wcfm-page-headig">
            ...
            <div class="wcfm-collapse-content">
                ...
                <div class="wcfm-container wcfm-top-element-container">
                    ...
                    if( $product_id && !$wcfm_is_translated_product && apply_filters( 'wcfm_is_allow_duplicate_product', true ) && apply_filters( 'wcfm_is_allow_product_limit', true ) ) {
                        if( WCFM_Dependencies::wcfmu_plugin_active_check() ) {
                            echo '<a id="wcfm_product_duplicate" class="wcfm_product_duplicate add_new_wcfm_ele_dashboard text_tip" href="#" data-proid="'. $product_id .'" data-tip="' . __('Duplicate Product', 'wc-frontend-manager') . '"><span class="wcfmfa fa-plus"></span><span class="text">' . __( 'Add Sublisting', 'wc-frontend-manager') . '</span></a>';
                ...
                <form id="wcfm_products_manage_form" class="wcfm">
                    ...
                    .listing-item {
                            ...
                            padding: 0px 10px 0px 10px;
                             ...
                             <div class="tabs">
                              ...
                              <label for="tabone">Listing Description</label>
                              <div class="tab">
                                    ...
                                    <div class="grid-container">
                                      ...
                                      <div class="item1">
                                        <div class="listing-container">
                                            <div class="listing-item">Listing Name</div>
                                                <div class="listing-item">
                                                     <?php
                                                                        $WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_product_manage_fields_general', array(
                                                                                                                                                                                                            "pro_title" => array( 'placeholder' => __('Listing Name', 'wc-frontend-manager') , 'type' => 'text', 'class' => 'wcfm-text wcfm_ele wcfm_product_title wcfm_full_ele simple variable external grouped booking', 'value' => $title),
                                                ...
                                                <div class="listing-item">
                                                    <p class="second-row-content">Why do people like working with you?</p>
                                                </div>
                                                <div class="listing-item">
                                                        ...
                                                        <?php
                                                            ...
                                                            $WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_product_manage_fields_content', array(
                                                                                                                                                                                                                        "excerpt" => array('label' => __('','wc-frontend-manager') , 'type' => $wpeditor, 'class' => 'wcfm-textarea wcfm_ele wcfm_full_ele simple variable external grouped booking ' . $rich_editor , 'label_class' => 'wcfm_title wcfm_full_ele ' . $rich_editor, 'rows' => 2, 'value' => $excerpt, 'teeny' => true ),
                                                                                                                                                                                                                        //"description" => array('label' => __('What kind of results do you help your clients achieve & how do you help them achieve those results', 'wc-frontend-manager') , 'type' => $wpeditor, 'class' => 'wcfm-textarea wcfm_ele wcfm_full_ele simple variable external grouped booking ' . $rich_editor, 'label_class' => 'wcfm_title wcfm_full_ele ' . $rich_editor, 'rows' => 10, 'value' => $description),
                                                ...
                                                <div class="listing-item">
                                                    <p class="second-row-content">What kind of results do you help your clients achieve & how do you help them achieve those results?</p>
                                                </div>
                                                 ...
                                                 <div class="listing-item">
                                                        ...
                                                        <?php
                                                            ...
                                                            $WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_product_manage_fields_content', array(
                                                                                                                                                                                                                        //"excerpt" => array('label' => __('','wc-frontend-manager') , 'type' => $wpeditor, 'class' => 'wcfm-textarea wcfm_ele wcfm_full_ele simple variable external grouped booking ' . $rich_editor , 'label_class' => 'wcfm_title wcfm_full_ele ' . $rich_editor, 'rows' => 2, 'value' => $excerpt, 'teeny' => true ),
                                                                                                                                                                                                                        "description" => array('label' => __('', 'wc-frontend-manager') , 'type' => $wpeditor, 'class' => 'wcfm-textarea wcfm_ele wcfm_full_ele simple variable external grouped booking ' . $rich_editor, 'label_class' => 'wcfm_title wcfm_full_ele ' . $rich_editor, 'rows' => 10, 'value' => $description),
                                                                                                                                                                                                                        "pro_id" => array('type' => 'hidden', 'value' => $product_id)
                                                                                                                                                                                                        ), $product_id, $product_type ) );
                                                        ?>
                                    ...
                                    <div class="item5">
                                      ...
                                      <div class="item3"><?php if( apply_filters( 'wcfm_is_category_checklist', true ) ) { ?>
                                    <?php 
                                    if( apply_filters( 'wcfm_is_allow_category', true ) && apply_filters( 'wcfm_is_allow_pm_category', true ) ) {
                                        if( apply_filters( 'wcfm_is_allow_product_category', true ) ) {
                                          ...
                                          <?php
                                          if( WCFM_Dependencies::wcfmu_plugin_active_check() ) {
                                                if( apply_filters( 'wcfm_is_allow_add_category', true ) && apply_filters( 'wcfm_is_allow_add_taxonomy', true ) && current_user_can("administrator") ) {
                                                    ?>
                                ...
                                <?php if( !apply_filters( 'wcfm_is_category_checklist', true ) ) { ?>
                                  ...
                                  <?php if( apply_filters( 'wcfm_is_allow_category', true ) && apply_filters( 'wcfm_is_allow_pm_category', true ) ) { ?>
                                    <?php if( apply_filters( 'wcfm_is_allow_product_category', true ) ) { $ptax_custom_arrtibutes = apply_filters( 'wcfm_taxonomy_custom_attributes', array(), 'product_cat' ); ?>
                                            ...
                                            <select id="product_cats" name="product_cats[]" class="wcfm-select wcfm_ele simple variable external grouped booking"  data-maximum-selection-length="<?php echo $catlimit; ?>" <?php echo implode( ' ', $ptax_custom_arrtibutes ); ?> style="width: 100%; margin-bottom: 10px;">
                                                <?php
                                                    if ( $product_categories ) {
                                ...
                                <?php } ?>
                                 <?php
                                    ...
                                    ?>
                                     ...
                                     <!--  <div class="item7"><?php if( apply_filters( 'wcfm_is_category_checklist', true ) ) { ?>
                                    <div class="wcfm_clearfix"></div><br />
                                    <div class="wcfm_product_manager_content_fields">
                                        <?php
                                        $rich_editor = apply_filters( 'wcfm_is_allow_rich_editor', 'rich_editor' );
                                        ...
                                        $WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_product_manage_fields_content', array(
                                                                                                                                                                                                                    "excerpt" => array( __( 'wc-frontend-manager') , 'type' => $wpeditor, 'class' => 'wcfm-textarea wcfm_ele wcfm_full_ele simple variable external grouped booking ' . $rich_editor , 'label_class' => 'wcfm_title wcfm_full_ele ' . $rich_editor, 'rows' => 3, 'value' => $excerpt, 'teeny' => true ),
                                                                                                                                                                                                                    //"description" => array( __( 'wc-frontend-manager') , 'type' => $wpeditor, 'class' => 'wcfm-textarea wcfm_ele wcfm_full_ele simple variable external grouped booking ' . $rich_editor, 'label_class' => 'wcfm_title wcfm_full_ele ' . $rich_editor, 'rows' => 2, 'value' => $description),
                                                                                                                                                                                                                    //"pro_id" => array('type' => 'hidden', 'value' => $product_id)
                                                                                                                                                                                                    ), $product_id, $product_type ) );
                                        ?>
                                ...
                                <?php } ?></div> -->
                                    ...
                                    <div class="footer">
                                        <input type="button" onclick="check()" class="wcfm_submit_button" value="<?php _e( 'Next', 'wc-frontend-manager' ); ?>" />
                                        <!-- <input type="button" class="wcfm_submit_button" value="<?php // _e( 'Previous', 'wc-frontend-manager' ); ?>" /> -->
                        
                                      </div>
                                    </div>
                        
                              <input type="radio" name="tabs" id="tabthree" <?php echo ($_COOKIE['sublisting_product']==$product_id ? "" : "disabled"); ?>>
                              <label for="tabthree">Cancellation Policy</label>
                              <div class="tab">
                                    <div class="wcfm_clearfix"></div><br />
                                <?php
                                $wcfm_tab_class = '';
                                ...
                                <!--</div>--> <!-- tabwrap -->
                                <div class="footer">
                                        <input type="button" id="next-button" onclick="checkschedule()" class="wcfm_submit_button" value="<?php _e( 'Next', 'wc-frontend-manager' ); ?>" />
                                        <input type="button" id="prev-button" onclick="checklisting()" class="wcfm_submit_button" value="<?php _e( 'Previous', 'wc-frontend-manager' ); ?>" />
                                      </div>
                                      <input type="number" id="current_product_id" value="<?php echo $product_id; ?>" hidden>
                                    <input type="text" id="duration_number" value="<?php echo get_post_meta($product_id,'_wc_appointment_duration')[0]; ?>" hidden>
                                    
                                </div>
                                
                                <!-- Schedule and Pricing Tabs -->
                                <?php if($product_id !=0): ?>
                               <input type="radio" name="tabs" id="tabtwo" checked="<?php echo ($product_id!=0 ? "checked" : ""); ?>" <?php echo ($_COOKIE['sublisting_product']==$product_id ? "" : "disabled"); ?>>
                              <label for="tabtwo">Schedule & Price</label>
                
                              <div class="tab">
                                <div class="grid-container-for-schedule">
                                  <!--<div class="grid-item-for-schedule">-->
                                  ...
                                  <div class="calend">
                                    ...
                                    <?php
                                     global $wpdb;
                                     $mycount=0;
                                        $settings = get_post_meta($product_id,'_wc_appointment_pricing');
                                        echo "<div class='pricerules'>";
                                       
                                        foreach($settings as $fld => $value ){
                                              
                                            foreach($value as $svalue){
                                                echo "<input class='basecost' value=".$svalue['base_cost'].">";
                                                echo "<input class='starttime' value=".$svalue['from'].">";
                                                echo "<input class='endtime' value=".$svalue['to'].">";
                                                echo "<input class='startdate' value=".$svalue['from_date'].">";
                                                echo "<input class='enddate' value=".$svalue['to_date']."><br>";
                                            }
                                        }
                                        echo '</div>';
                                    ?>
                        ...
                        <iframe src="<?php echo get_home_url(); ?>/schedule-and-listing/" height="750px" width="750px" id="calendarFrame"></iframe>

                                <!--/raniel-->
                                <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js" integrity="sha256-KsRuvuRtUVvobe66OFtOQfjP8WA2SzYsmm4VPfMnxms=" crossorigin="anonymous"></script>
                                <script>
                                jQuery('#wcfm_product_duplicate').on('click',function(){
                                    swal({
                                        title:"Creating Sublisting",
                                        text:"All categories, tags, policy, schedule and pricing will be the same on your main listing",
                                        icon: "info"
                                    });
                                    <?php add_sublisting($product_id); ?>
                                });
                                  ...
                                  <div class="rightSide">
                                <!--  <script>-->
                                <!--    $("#product_type option[value=appointment]").attr('selected', 'selected');-->
                                <!--</script>-->
                                <?php
                                $wcfm_tab_class = '';
                                if( $wcfm_is_translated_product ) {
                                    $wcfm_tab_class = 'wcfm_wpml_hide';
                                    ?>
                                    <!--<div class="wcfm-container simple variable external gro//uped booking">-->
                                        <p class="description" style="color:#f86c6b;font-size:15px;margin:10px 15px;width:100%;">
                                            <?php _e( 'It\'s a translated product, so product meta fields are blocked for editing because WPML will copy its value from the original language.', 'wc-frontend-manager' ); ?>
                                        </p>
                                    <!--</div>-->
                                ...
                                <!--</div>--> <!-- tabwrap -->
                                  ...
                                  <div class="grid-item-for-schedule1"></div>
                                  <div class="grid-item-for-schedule"><?php
                                    $WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_product_manage_fields_general', array(
                                                                                                                                                                                                        //"product_type" => array('type' => 'select', 'options' => $product_types, 'class' => 'wcfm-select wcfm_ele wcfm_product_type wcfm_full_ele simple variable external grouped booking ' . $product_type_class . ' ' . $wcfm_wpml_edit_disable_element, 'label_class' => 'wcfm_title wcfm_ele simple variable external grouped booking', 'value' => $product_type ),
                                                                                                                                                                                                        //"is_virtual" => array('desc' => __('Virtual', 'wc-frontend-manager') , 'type' => 'checkbox', 'class' => 'wcfm-checkbox wcfm_ele wcfm_half_ele_checkbox simple booking non-variable-subscription non-job_package non-resume_package non-redq_rental non-accommodation-booking' . ' ' . $wcfm_wpml_edit_disable_element, 'desc_class' => 'wcfm_title wcfm_ele virtual_ele_title checkbox_title simple booking non-variable-subscription non-job_package non-resume_package non-redq_rental non-accommodation-booking' . ' ' . $wcfm_wpml_edit_disable_element, 'value' => 'enable', 'dfvalue' => $is_virtual),
                                                                                                                                                                                                        //"is_downloadable" => array('desc' => __('Downloadable', 'wc-frontend-manager') , 'type' => 'checkbox', 'class' => 'wcfm-checkbox wcfm_ele wcfm_half_ele_checkbox simple appointment non-variable-subscription non-job_package non-resume_package non-redq_rental non-accommodation-booking' . ' ' . $wcfm_wpml_edit_disable_element, 'desc_class' => 'wcfm_title wcfm_ele downloadable_ele_title checkbox_title simple appointment non-variable-subscription non-job_package non-resume_package non-redq_rental non-accommodation-booking' . ' ' . $wcfm_wpml_edit_disable_element, 'value' => 'enable', 'dfvalue' => $is_downloadable),
                                ...
                                <!--<script>-->
                                <!--    $("#_wc_appointment_requires_confirmation").prop('checked' , true);-->
                                <!--    $("#_wc_appointment_user_can_cancel").prop('checked' , true);-->
                                <!--</script>-->
                                

                                  <!--<div class="grid-item-for-schedule">
                                    <input type="date" name="firstname" id="from" disabled="disabled" />
                                    <script>
                                        $('#_wc_appointment_availability_rules_from_custom_0').change(function() {
                                        $('#from').val($(this).val());
                                    });
                                    </script>-->
                                  <!--</div>
                                ...
                                <div class="footer">
                                        <input type="button" onclick="checkreview()" class="wcfm_submit_button" value="<?php _e( 'Next', 'wc-frontend-manager' ); ?>" />
                                        <input type="button" onclick="check()" class="wcfm_submit_button" value="<?php _e( 'Previous', 'wc-frontend-manager' ); ?>" />
                        ...
                        <!-- /Schedule and Pricing Tabs -->
                               ...
                               <input type="radio" name="tabs" id="tabfour" onclick="alertDuration();">

                              <label for="tabfour">Review & Publish</label>
                              <div class="tab">
                    ...
                    <div class="listing-container">
                      <div class="listing-item">
                        <p>Listing Name</p></div>
                      <div class="listing-item">
                        <p id="listing"> <?php echo $title;?>
                        </p>
                    </div>
                      <div class="listing-item">
                        <p class="text-result">
                          <p class="results">What kind of results do you help your clients achieve & how do you help them achieve those results</p>
                        </p>
                      </div>  
                      <div class="listing-item">
                     <p id="excerptview"><?php echo $excerpt;?></p>
                      </div>
                      <div class="listing-item">
                            <p class="results">Why do people like working with you?</p></div>
                      <div class="listing-item">
                            <p id="descriptionview"><?php echo $description;?></p></div>  

                      <div class="listing-item" style="visibility:hidden">
                      <p class="priceview">Price</p>
                      </div>

                      <div class="listing-item" style="visibility:hidden">
                      <p><input type="text" class="pro-title" name="priceview" id="priceview" disabled="disabled" /></p></div>
                      <div class="listing-item" style="visibility:hidden">9</div>  
                    </div>
                                <div class="footer">
                                        <!-- <input type="button" class="wcfm_submit_button" value="<?php // _e( 'Next', 'wc-frontend-manager' ); ?>" /> -->

                                        <input type="submit" name="submit-data" value="<?php if( apply_filters( 'wcfm_is_allow_publish_live_products', true ) ) { _e( 'Submit', 'wc-frontend-manager' ); } else { _e( 'Submit for Review', 'wc-frontend-manager' ); } ?>" id="wcfm_products_simple_submit_button" class="wcfm_submit_button" onclick="alertNotif();"/>
                                        <?php } else { ?>
                                        <input type="submit" name="submit-data" value="<?php if( apply_filters( 'wcfm_is_allow_publish_products', true ) ) { _e( 'Submit', 'wc-frontend-manager' ); } else { _e( 'Submit for Review', 'wc-frontend-manager' ); } ?>" id="wcfm_products_simple_submit_button" class="wcfm_submit_button" onclick="alertNotif();"/>
                                        <?php } ?>
                                        <input type="button" onclick="checkschedule()" class="wcfm_submit_button" value="<?php _e( 'Previous', 'wc-frontend-manager' ); ?>" />
                        ...
                        <!-- <?php if( !apply_filters( 'wcfm_is_category_checklist', true ) ) { ?>
                            <div class="wcfm-content">
                                <div class="wcfm_product_manager_content_fields">
                                    ...
                                    $WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_product_manage_fields_content', array(
                                                                                                                                                                                                                // "excerpt" => array('label' => __('Short Description', 'wc-frontend-manager') , 'type' => $wpeditor, 'class' => 'wcfm-textarea wcfm_ele wcfm_full_ele simple variable external grouped booking ' . $rich_editor , 'label_class' => 'wcfm_title wcfm_full_ele', 'rows' => 2, 'value' => $excerpt, 'teeny' => true),
                                                                                                                                                                                                                // "description" => array('label' => __('Description', 'wc-frontend-manager') , 'type' => $wpeditor, 'class' => 'wcfm-textarea wcfm_ele wcfm_full_ele simple variable external grouped booking ' . $rich_editor, 'label_class' => 'wcfm_title wcfm_full_ele', 'rows' => 2, 'value' => $description),
                                                                                                                                                                                                                //"pro_id" => array('type' => 'hidden', 'value' => $product_id)
                                                                                                                                                                                                ), $product_id, $product_type ) );
                                    ?>
