                                  ...
                                  <!-- Modal content -->
                                      ...
                                      echo "string";
                                       echo "<h1 class='cancellation-title'>Cancellation Policy</h1><div class='policy-modal'>";
                                        ...
                                        echo "</div><h1 class='confirmation'>Are you sure you want to cancel this appointment?</h1>
                                        <button class='transac-buttons' onclick='transacDeleteStatus(".$appointment_id.")'>Yes</button>
