        ...
        <div class="wcfm-collapse-content">
          ...
          <div class="full-details">
            <div class="informaiton-details">
                ...
                <p class="appointment-cancellation">Cancellation Policy: <p style="color: green">
                    <?php
                            ...
                            <div class='btn-position'>
                                  ...
                                  <!-- Modal content -->
                                      <div class='modal-content'>
                                        ...
                                        [INSERT_ELEMENTOR id='55728']
                                        <p class='confirmation'>Are you sure you want to cancel this appointment?</p>
                                        <button class='transac-buttons' onclick='transacDeleteStatus(".$appointment_id.")'>Cancel Appointment</button>
                                      </div>
