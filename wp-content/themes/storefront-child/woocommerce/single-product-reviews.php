...
<?php if ( get_option( 'woocommerce_review_rating_verification_required' ) === 'no' || wc_customer_bought_product( '', get_current_user_id(), $product->get_id() ) ) : ?>
        ...
        <div class="col-sm-3">
                <div class="author-name">
                  <?php
                  echo 'Professional:', woocommerce_product_author();
                  ?>
                </div>
                <div class="ratings-content">
                <p>Overall Rating: </p><p class="color-rating"><?php echo get_star_rating();?></p>
                </div><br>
                <div class="ratings-content">
                <p>Helpfulness: </p><?php echo get_star_rating();?>
                </div>
                <div class="ratings-content">
                <p>Preparedness: </p><?php echo get_star_rating();?>
                </div>
                <div class="ratings-content">
                <p>Professionalism: </p><?php echo get_star_rating();?>
                </div>
                <div class="ratings-content">
                <p>Communication Skills: </p><?php echo get_star_rating();?>
                </div>
                <div class="ratings-content">
                <p>Recommendation: </p><?php echo get_star_rating();?>
                </div>
        </div>
        <?php 
