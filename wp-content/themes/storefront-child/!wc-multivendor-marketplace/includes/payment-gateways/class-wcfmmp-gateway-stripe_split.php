...
class WCFMmp_Gateway_Stripe_Split extends WC_Payment_Gateway {
	...
	public function process_payment($order_id) {
		...
		$wcfmmp_stripe_split_pay_list = $WCFMmp->wcfmmp_commission->wcfmmp_split_pay_vendor_list( $order, $_POST );
	...
	public function process_response( $response, $order ) {
		...
		if ( 'yes' === $captured ) {
			...
			if ( 'succeeded' === $response->status ) {
				...
				$wcfmmp_stripe_split_pay_list = $WCFMmp->wcfmmp_commission->wcfmmp_split_pay_vendor_list( $order, array() );
		...
		try {
			...
			if( is_wc_endpoint_url( 'order-pay' ) ) {
				$customer_data = apply_filters('wcfmmp_stripe_split_pay_customer_data', array(
																									...
																									"source" => sanitize_text_field( $postData['stripe_source'] ),
