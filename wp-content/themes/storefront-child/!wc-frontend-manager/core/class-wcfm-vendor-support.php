  ...
  function vendors_wcfm_menus( $menus ) {
	...
	function wcfm_associate_vendor( $product_id, $product_type, $wcfm_is_translated_product = false, $wcfm_wpml_edit_disable_element = '' ) {
		...
		if( $is_marketplace ) {
			...
			<div class="page_collapsible products_manage_vendor_association simple variable grouped external booking <?php echo $wcfm_wpml_edit_disable_element; ?>" id="wcfm_products_manage_form_vendor_association_head"><label class="wcfmfa fa-user-alt fa-user-alt"></label><?php _e('Store', 'wc-frontend-manager'); ?><span></span></div>
